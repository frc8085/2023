...
public class Altitude extends SubsystemBase {
  ...
  public Altitude(Extension Extension) {
    ...
    m_altitudeMotor.setIdleMode(com.revrobotics.CANSparkBase.IdleMode.kBrake);
  ...
  public void keepPosition(double positionAltitude) {
    ...
    // vs lower)
    m_altitudePIDController.setReference(positionAltitude, com.revrobotics.CANSparkBase.ControlType.kPosition, slotID);
