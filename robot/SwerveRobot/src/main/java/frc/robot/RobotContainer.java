...
public class RobotContainer {
  ...
  private void configureAuto() {
    ...
    autoSelection.addOption(
        "BALANCE", Autos.balance3(m_robotDrive, m_altitude, m_extension));

    autoSelection.addOption(
        "LeaveTurn",
        Autos.leaveAndTurn(m_robotDrive, m_altitude, m_extension, m_intake));
    autoSelection.addOption(
        "Pick up hold",
        Autos.pickUpAndHold(m_robotDrive, m_altitude, m_extension, m_intake));
  ...
  // public Command getAutonomousCom

  // TrajectoryConfig config = new Traj

  // // Add kinematics to ensure
  // .setKinematics(DriveConstants.kDriveKinematics);

  // // An example trajectory to
  ...
  // m_robotD
  // DriveConstants.kDriveK

  // new PIDController(Auto
  // new PI
