...
import frc.robot.commands.Autos.Shared.ResetPositionToStart;
...
public class RobotContainer {
    ...
    public Command getAutonomousCommand() {
        ...
        Command resetPosition = new ResetPositionToStart(m_altitude, m_extension);
        return resetPosition.andThen(autoSelection.getSelected());
    }
