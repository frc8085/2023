...
public class RobotContainer {
        ...
        private void configureButtonBindings() {
                ...
                final JoystickAxisButton coneIntakeButton = new JoystickAxisButton("Pickup",
                                m_operatorController::getRightTriggerAxis, 0.5);

                // Create fake button to correspond to left trigger pressed
                final JoystickAxisButton ejectButton = new JoystickAxisButton("Eject",
                ...
                final JoystickButton returnToTravelPositionButton = new JoystickButton(m_operatorController,
                                Button.kB.value);
                ...
                returnToTravelPositionButton.onTrue(
                                new InstantCommand(m_Elevator::MoveElevatorToTravelPosition, m_Elevator)
                                                .andThen(new InstantCommand(m_Arm::MoveArmToTravelPosition, m_Arm)));
                ...
                armRetractButton.whileTrue(
                                new InstantCommand(m_Arm::retractElevatorArm, m_Arm));
