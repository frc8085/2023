...
import frc.robot.subsystems.limelight.AlignWithConeNodeLeft;
import frc.robot.subsystems.limelight.AlignWithConeNodeRight;
...
public class RobotContainer {
  ...
  private final LimelightSubsystem m_limelight2 = new LimelightSubsystem();
  ...
  private void configureButtonBindings() {
    ...
    final Trigger coneLeft = m_operatorController.povLeft(

    );
    final Trigger coneRight = m_operatorController.povRight();
    ...
    coneLeft.whileTrue(new AlignWithConeNodeLeft(m_limelight2, m_robotDrive)).onFalse(
        new InstantCommand(m_robotDrive::stop));
    coneRight.whileTrue(new AlignWithConeNodeRight(m_limelight2, m_robotDrive)).onFalse(
        new InstantCommand(m_robotDrive::stop));
