...
public final class Autos {
  ...
  public static CommandBase balance3(DriveSubsystem m_drive,
      Altitude m_altitude, Extension m_extension) {
    return Commands.sequence(
  ...
  // still testing
  public static CommandBase leaveSpinPickup(DriveSubsystem m_drive, Altitude m_altitude,
      Extension m_extension,
      Intake m_intake) {
    return Commands.sequence(
        initialize(m_drive, m_altitude, m_extension),
        new AutoDriveMetersAndTurn(m_drive, -2 / Math.PI, 0, .4, -180, .4));
  }

  // still testing
  public static CommandBase leaveAndTurn(DriveSubsystem m_drive, Altitude m_altitude,
      Extension m_extension,
      Intake m_intake) {
    return Commands.sequence(
        initialize(m_drive, m_altitude, m_extension),
        ...
        new WaitCommand(.2),
        pickUpAndHold(m_drive, m_altitude, m_extension, m_intake),
        ...
        new WaitUntilCommand(
            () -> m_extension.ExtensionIsInHighCubeShootPosition()),
  ...
  // still testing
  public static CommandBase pickUpAndHold(DriveSubsystem m_drive, Altitude m_altitude,
      Extension m_extension,
      Intake m_intake) {
    return Commands.sequence(
  ...
  public static CommandBase scoreHighLeavePickupReturnandScore(DriveSubsystem m_drive, Altitude m_altitude,
    ...
    return Commands.sequence(
        ...
        new AutoRotateDegrees(m_drive, 180),
        new AutoDriveForwardMeters(m_drive, 5, .4),
        scoreHigh(m_drive, m_altitude, m_extension, m_intake));
  }
  ...
  public static CommandBase ScoreLeaveAndBalance(DriveSubsystem m_drive, Altitude m_altitude,
    ...
    return Commands.sequence(
        ...
        new AutoDriveBackwardsMeters(m_drive, 4.25, .4),
        new InstantCommand(m_intake::stopIntake),
        new AutoDriveForwardMeters(m_drive, 2.5, .4),
        new WaitCommand(1),
