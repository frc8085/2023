...
public class AutoMoveToPickupAndStartLoweringIntakeClean extends SequentialCommandGroup {
  public AutoMoveToPickupAndStartLoweringIntakeClean(
    ...
    addCommands(
        new ParallelCommandGroup(
            ...
            .deadlineWith(travelBackwardsThenSpin(m_drive)));
